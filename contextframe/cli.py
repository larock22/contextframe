...
def _handle_conflict_check(args):
    ...
    try:
        # Load documents
        local_doc = FrameRecord.from_file(local_path)
        remote_doc = FrameRecord.from_file(remote_path)
...
def _handle_conflict_merge(args):
    ...
    try:
        ...
        try:
            ...
            print("Use 'contextframe conflicts create-resolution-file' to create a file for manual resolution", file=sys.stderr)
            return 1
    except Exception as e:
...
def _handle_conflict_resolution_file(args):
    ...
    try:
        ...
        print("Edit this file to resolve conflicts, then use 'contextframe conflicts apply-resolution' to apply the changes")
        return 0
    except Exception as e:
